...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-787-erd-s-problem-787-eaec40fc-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-787"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-787-erd-s-problem-787-eaec40fc-v1",
      "problem_contract_sha256": "51abc8eb3927565a6f3f6600a1dc68280335804276a6dbb003a52c1bfac84ad0",
      "problem_id": "problem:um-ep-787-erd-s-problem-787-eaec40fc",
      "route_id": "route:um-ep-787-erd-s-problem-787-eaec40fc-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-787-erd-s-problem-787-eaec40fc-source-fidelity-01",
      "graph_id": "graph:um-ep-787-erd-s-problem-787-eaec40fc-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-787-erd-s-problem-787-eaec40fc-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-787-erd-s-problem-787-eaec40fc-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $g(n)$ be maximal such that given any set $A\\subset \\mathbb{R}$ with $\\lvert A\\rvert=n$ there exists some $B\\subseteq A$ of size $\\lvert B\\rvert\\geq g(n)$ such that $b_1+b_2 ot\\in A$ for all $b_1 eq b_2\\in B$. Estimate $g(n)$."
          },
          "statement_sha256": "4853f9d130bef4b5758b746006994e88670e6fadef47b011900c472a2f2637f2"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-787-erd-s-problem-787-eaec40fc-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-787-erd-s-problem-787-eaec40fc-root",
      "route_id": "route:um-ep-787-erd-s-problem-787-eaec40fc-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-787-0319d2a8971c",
        "url": "https://www.unsolvedmath.com/problems/EP-787"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
